      ...
      >
        <div className="linksBox">
          <div className="linksContents">
            ...
            <Words>
              rsync is constantly in sync with the current repo available and is
              the best way to acquire all the files and keep them updated as new
              projects are added to save on bandwidth for you and server, but as
              a caveat I have also provided alternative download links that are
            ...
            <Words>
              ...
              networked computers by comparing the modification times and sizes
              of files.
            </Words>
            ...
            >
              <div className="insideFrame">
                ...
                <Code language="bash" className="code">
                  rsync -avzh rsync://print2a.com:1776/print2a /Copy-To-This/Dir
                </Code>
              </div>
            </Frame>
          </div>
